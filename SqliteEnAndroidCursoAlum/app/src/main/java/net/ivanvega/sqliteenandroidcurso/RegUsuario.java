	...
	private void update() {
		...
		try {
			if( dao.update(usuario)){
				Toast.makeText(getBaseContext(), "USUARIO EDITADO CORRECTAMENTE",
						Toast.LENGTH_LONG).show();
				setResult(RESULT_OK, null);
				finish();
			}else {
				Toast.makeText(getBaseContext(), "ALGO FALLO AL EDITAR USUARIO",
						Toast.LENGTH_LONG).show();
	...
	private void insert() {
		...
		try {
			if( dao.insert(usuario)){
				Toast.makeText(getBaseContext(), "USUARIO INSERTADO CORRECTAMENTE ",
						Toast.LENGTH_LONG).show();
				setResult(RESULT_OK, null);
				finish();
			}else {
