...
public class ProviderBDUser extends ContentProvider {
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        try {
            ...
            if (true) {
             ...
             Toast.makeText(getContext(),"DATO NO VALIDO",Toast.LENGTH_SHORT).show();
            Log.e("ERROR", "ADATO NO VALIDO: " + e.toString());
        }
        ...
        if (registro > 0) {
            ...
            Log.e("INSERT", "REGISTRO AGREGADO CORRECTAMENTE");
        } else {
            Toast.makeText(getContext(),"SE PRODUJO UN ERROR",Toast.LENGTH_SHORT).show();
            Log.e("ERROR", "SE PRODUJO UN ERROR: " + registro);
        }
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        try {
            ...
            Log.e("ERROR", "DATO NO VALIDO: " + e.toString());
        }
