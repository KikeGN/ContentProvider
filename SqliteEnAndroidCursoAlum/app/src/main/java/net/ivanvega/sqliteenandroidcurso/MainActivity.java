...
public class MainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		dao.insert(new Usuario(0, "Nallely Villicaña", "nalle_villi@gmail.com", "kike"));
		dao.insert(new Usuario(0, "Kike GN", "quique00@hotmail.es", "nalle"));
		cargarLista();
	}
	...
	private void eliminar(int idUsuario) {
		...
		adb.setTitle("ELIMINAR USUARIO");
		adb.setMessage("SEGURO QUE DECEAS ELIMINAR EL USUARIO?");
		...
		adb.setPositiveButton("si", new OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which) {
				...
				if( dao.delete(_id)){
					cargarLista();
					Toast.makeText(getBaseContext(), "COMPLETADO CORRECTAMENTE", Toast.LENGTH_SHORT).show();
				}
			}
		});
